...
export type View =
  ...
  | { type: 'SCORES', gameId: string, isReady: [t.PlayerId, boolean][], secsLeft?: number, scores: [t.PlayerId, number][], positions?: [t.PlayerId, number, number][], category: string, guesses?: [t.PlayerId, string][] }
